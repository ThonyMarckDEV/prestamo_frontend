...
import {
  ...
  FaUsers, FaChartBar, FaClipboardList, FaCalendarAlt, FaSignOutAlt, FaBars, FaTimes, FaUserTie
} from 'react-icons/fa';
    ...
    <div className="min-h-screen flex relative">
      ...
      >
        ...
        <nav className="p-4 space-y-6 flex-1">
          <Link to="/cliente/estados" className="flex items-center gap-3 hover:text-gray-300" onClick={() => setSidebarOpen(false)}>
            <FaChartBar /> PAGAR CUOTAS
          </Link>
          <Link to="/cliente/mispagos" className="flex items-center gap-3 hover:text-gray-300" onClick={() => setSidebarOpen(false)}>
            <FaCalculator /> MIS PAGOS
          </Link>
        </nav>
