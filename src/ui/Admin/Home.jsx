...
export default function Inicio() {
  return (
    <div className="min-h-screen bg-neutral-softWhite flex flex-col items-center p-6">
      <h1 className="text-3xl md:text-4xl font-bold text-primary mb-8">PrestamoDemo Control Panel</h1>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 max-w-4xl w-full">
        <Link
          to="/admin/calculadora"
          className="bg-neutral-white border-2 border-primary rounded-lg p-6 md:p-8 flex flex-col items-center justify-center text-primary hover:scale-105 hover:shadow-lg transition-transform duration-200"
        >
          <Calculator size={36} />
